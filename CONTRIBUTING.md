...
won't clash or be obviated by ORY Works's normal direction. A great way to
do this is via
[ORY Works Discussions](https://github.com/ory/Works/discussions) or
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Works. Github stars help the project gain visibility and stand out.
...
Check out
[ORY Works Discussions](https://github.com/ory/Works/discussions).
...
[docs](https://github.com/ory/Works/tree/master/docs) folder. Generate API
...
git clone git@github.com:ory/Works.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/Works.git
